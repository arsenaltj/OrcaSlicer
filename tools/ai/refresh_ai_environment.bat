...
for %%V in (OPENAI_PRO_URL OPENAI_PRO_API OPENAI_BASE_URL OPENAI_API_KEY OPENAI_TEXT_MODEL OPENAI_IMAGE_MODEL TRIPO_API_KEY TRIPO_API_BASE TRIPO_MODEL PYTHON_EXE ORCASLICER_AI_ALLOW_PREPROCESS_FALLBACK) do call :refresh_windows_environment %%V
exit /b 0

...
- An explicit request to remember or revise a preference is sufficient; do not ask for the same permission again.
- For preference storage, edit `~/code/memory.md`; edit skills only when the user has requested skill or persistent-instruction changes.
